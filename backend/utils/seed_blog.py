...
def seed_blogs():
    ...
    mock_blogs = [
        ...
        },
        {
            ...
            "excerpt": "Learn about TechFlow's journey from a small startup idea to a leading AgTech company, and the role our incubation event played in their success.",
