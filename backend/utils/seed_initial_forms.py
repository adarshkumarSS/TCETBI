"""
Seed initial form templates with fields matching current forms
...
def seed_forms():
    ...
    if created:
        ...
        print(f"  Added {len(funding_fields)} fields")
    ...
    if created:
        ...
        print(f"  Added {len(mentoring_fields)} fields")
    ...
    if created:
        ...
        print(f"  Added {len(validation_fields)} fields")
    ...
    if created:
        ...
        print(f"  Added {len(contact_fields)} fields")
    
    # 5. Incubation Application Form (simplified version - full version has many more fields)
